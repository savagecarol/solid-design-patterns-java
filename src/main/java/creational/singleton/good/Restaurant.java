...
public class Restaurant {
    public static void main(String[] args) {
        ...
        BillingService billingServiceWaiter1 = BillingService.getInstance(); // tried making instance 2 times
        billingServiceWaiter1.addInTotal(100);

        System.out.println("Customer 2 comes and give order to waiter 2 amount 200");
        BillingService billingServiceWaiter2 = BillingService.getInstance(); // tried making instance 2 times
